...
class PartnerModel extends AdminModel
{
    ...
    public function listItems($params = null, $options = null) {
        ...
        if($options['task'] == "admin-list-items") {
            $query = $this->select('id', 'name', 'status', 'link', 'thumb','created', 'ordering', 'created_by', 'modified', 'modified_by');
        ...
        if($options['task'] == 'news-list-items') {
            $query = $this->select('id', 'name', 'status', 'link', 'thumb')
                        ->where('status', '=', 'active' )
    ...
    public function getItem($params = null, $options = null) { 
        ...
        if($options['task'] == 'get-item') {
            $result = self::select('id', 'name', 'status', 'ordering','link', 'thumb')->where('id', $params['id'])->first();
        }
